        ...
        @foreach ($fields as $field)
            <tr>
                ...
                <td>
                    ...
                    <a title="configurer la grille" href="#" class="bg-white btn btn-sm">
                    ...
                    {{--  //$this->Form->postLink(__('<i class="fa fa-times text-danger"></i>'), ['controller' => 'Fields', 'action' => 'delete', $field->id], ['escape' => false,'class' => 'btn bg-white btn-sm', 'confirm' => __('Voulez vous supprimer :  {0}?', $field->name)])  --}}
                </td>
            </tr>
        @endforeach
    </tbody>
