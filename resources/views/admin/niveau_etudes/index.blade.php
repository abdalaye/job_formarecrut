        ...
        <div class="card shadow-none rounded">
            <div class="card-body">
                ...
                @include('partials.element.form_range', [
                    ...
                    'entityModel' => get_class($niveauEtude)
                ])
            </div>
        </div>
    </div>
...
@section('tableBody')
    ...
    @foreach ($niveau_etudes as $niveauEtudeItem)
        <tr>
            ...
            <td>
                <a href="{{ route('admin.niveau_etudes.update', $niveauEtudeItem) }}" data-toggle="modal"
                    data-target="#modelId" data-id="{{ $niveauEtudeItem->id }}"
                    data-name="{{ $niveauEtudeItem->name }}" data-statut="{{ $niveauEtudeItem->statut }}"
                ...
                @include('partials.components.deleteBtnElement', [
                    ...
                    'message_confirmation' =>
                        'Voulez-vous supprimer le niveau suivant :' . $niveauEtudeItem->name,
